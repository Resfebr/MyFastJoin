...
public class MonitorBolt extends BaseRichBolt{
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream(MONITOR_R_TO_JOINER_STREAM_ID, new Fields(TO_JOINER_SCHEMA));
        declarer.declareStream(MONITOR_S_TO_JOINER_STREAM_ID, new Fields(TO_JOINER_SCHEMA));
    }
